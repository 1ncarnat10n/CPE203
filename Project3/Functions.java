...
*/
      ...
      EventScheduler scheduler, ImageStore imageStore)
   {
      ...
      WorldView.removeEntity(world, entity);
      scheduler.unscheduleAllEvents(entity);
      ...
      Entity target, EventScheduler scheduler)
   {
      if (adjacent(octo.position, target.position))
      {
         ...
         WorldView.removeEntity(world, target);
      ...
      Entity target, EventScheduler scheduler)
   {
      ...
      {
         Point nextPos = world.nextPositionOcto(octo, target.position);
   ...
   */
                                  ...
                                  WorldModel world, ImageStore imageStore)
   {
      if (properties.length == Functions.BGND_NUM_PROPERTIES)
      {
         ...
         world.background.setBackground(world, pt);
      }
      ...
      ImageStore imageStore)
   {
      if (properties.length == SGRASS_NUM_PROPERTIES)
      {
         ...
         Entity entity = world.createSgrass(properties[SGRASS_ID], // changed createSgrass to entity.createSgrass
            pt,
