...
final class WorldModel
{
   ...
   public static final String BACKGROUND_KEY = "backgroundEntity";
   public static final int BACKGROUND_NUM_PROPERTIES = 4;
   public static final int BACKGROUND_ID = 1;
   public static final int BACKGROUND_COL = 2;
   public static final int BACKGROUND_ROW = 3;
   ...
   public static final int DEMON_NUM_PROPERTIES = 7;
   public static final int DEMON_ID = 1;
   public static final int DEMON_COL = 2;
   public static final int DEMON_ROW = 3;
   public static final int DEMON_ACTION_PERIOD = 5;
   public static final int DEMON_ANIMATION_PERIOD = 6;
                                                ...
                                                Point pos)
   {
      ...
      else
      {
         ...
         int nearestDistance = nearest.getPosition().distanceSquared(nearest.getPosition(), pos);
   ...
   public boolean parseDemon(String [] properties, ImageStore imageStore)
   {
      if (properties.length == DEMON_NUM_PROPERTIES)
      {
         Point pt = new Point(Integer.parseInt(properties[DEMON_COL]),
                 Integer.parseInt(properties[DEMON_ROW]));
         Entity entity = Demon.createDemon(properties[DEMON_ID],
                 pt,
                 Integer.parseInt(properties[DEMON_ACTION_PERIOD]),
                 Integer.parseInt(properties[DEMON_ANIMATION_PERIOD]),
   ...
   public boolean parseBackgroundEntity(String [] properties, ImageStore imageStore)
   {
      if (properties.length == BACKGROUND_NUM_PROPERTIES)
      {
         Point pt = new Point(
                 Integer.parseInt(properties[BACKGROUND_COL]),
                 Integer.parseInt(properties[BACKGROUND_ROW]));
         Entity entity = BackgroundEntity.createBackgroundEntity(properties[BACKGROUND_ID],
                 pt, imageStore.getImageList(BACKGROUND_KEY));
         this.tryAddEntity(entity);
      }

      return properties.length == BACKGROUND_NUM_PROPERTIES;
   }
...
//            case DEMON_KEY:
  //            return this.parseDemon(properties, imageStore);
         }
      }
